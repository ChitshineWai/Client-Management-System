...
if($_SESSION['pass'] == ""){
 ...
 <?php
 $user_id = $_GET['id'];
 $billingid = mt_rand(1000,5000);
 if(isset($_POST['submit'])){
 $asignid = $_POST['asign'];
 for($i=0;$i<count($asignid);$i++){
    $asignidd = $asignid[$i];
    $insert_selc = "INSERT INTO `invoice_tb` VALUES (NULL,'$user_id','$asignidd','$billingid',NOW())";
    $con->query($insert_selc);
    echo "<script>alert('invoice id $billingid have been successfully')</script>";
    echo "<script>window.location.href='invoice/invoice.php'</script>";
}
}
 ?>
    <!DOCTYPE html>
  ...
  <link rel="stylesheet" href="vendors/mdi/css/materialdesignicons.min.css">
    ...
    <div class="container-scroller">
        ...
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo mr-5" href="home.php"><img src="images/logo.svg" class="mr-2"
                alt="logo" /></a>
        ...
        <div class="main-panel">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                    <h4 class="card-title">Assing Service</h4>
                    ...
                    <div class="table-responsive pt-3">
                        ...
                        <form method="post">
                            ...
                            while($row = mysqli_fetch_array($r)){
                                ...
                                <td>MMK - $row[service_price]</td>
                                <td>$row[creation_date]</td>
                                <td><div class='form-check form-check-primary'>
                                <label class='form-check-label'>
                                  <input type='checkbox' class='form-check-input' name='asign[]' value='$row[id]'>
                                </label>
                              </div></td>
                                </tr>";
                            ...
                            <tr><td colspan='5' align='end'><button type="submit" name="submit" class="btn btn-primary">Submit</button></td></tr></form>
                        </tbody>
                        </table>
                    </div>
                    </div>
